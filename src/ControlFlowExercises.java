...
//        }
        ...
        if(userConfirmation.toLowerCase().contains("y")){
            ...
            else if(userGradeNumber < 88 && userGradeNumber >= 84) System.out.println("You have a B+");
            else if(userGradeNumber < 84 && userGradeNumber >= 82) System.out.println("You have a B");
            else if(userGradeNumber < 82 && userGradeNumber >= 80) System.out.println("You have a B-");
            else if(userGradeNumber < 80 && userGradeNumber >= 75) System.out.println("You have a C+");
            else if(userGradeNumber < 75 && userGradeNumber >= 72) System.out.println("You have a C");
            else if(userGradeNumber < 72 && userGradeNumber >= 67) System.out.println("You have a C-");
            else if(userGradeNumber < 67 && userGradeNumber >= 64) System.out.println("You have a D+");
